        ...
        <AnimatePresence>
          {expanded && (
            <motion.div
              ...
              transition={{ duration: 0.4 }}
              className="mt-6 bg-sky-300 bg-opacity-80 border-2 border-white rounded-xl p-6 backdrop-blur-md shadow-xl text-cyan-100 drop-shadow-[0_0_6px_rgba(0,255,255,0.5)] text-left leading-relaxed"
            >
              {/* 👤 Image + Bio */}
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1">
                  <h2 className="text-2xl font-bold mb-3 text-cyan-200 drop-shadow-md">Hey, I'm Dylan 👋</h2>
              ...
              {/* 🧰 Tech Stack */}
              <div className="mt-8">
                <h3 className="text-xl font-semibold mb-4 text-center text-cyan-200 drop-shadow-md">🧰 Tech Stack</h3>
                <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-4 justify-items-center">
                  {technologies.map((tech) => (
                    ...
                    >
                      {tech.icon}
                      <span className="text-sm mt-1 text-cyan-100 drop-shadow-sm">{tech.name}</span>
                    </div>
                  ))}
                </div>
              </div>
